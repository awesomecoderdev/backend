...
@endif" x-show="{{ $alertKey }}"
    ...
    class="hidden w-full z-50 max-w-sm bg-white dark:bg-gray-800 border-gray-100 dark:border-slate-700 border dark:text-slate-300 shadow-lg drop-shadow-sm shadow-black/10 dark:shadow-primary-500/30 rounded-lg transition-all duration-500 ring-1 ring-black ring-opacity-5 overflow-hidden cursor-text">
    <div class="p-4">
