...
<div class="relative bg-white flex mx-auto justify-between w-full h-fit">
    <div class="relative overflow-x-hidden lg:w-80 w-auto h-auto min-h-screen shadow ">
        <div class="relative w-full h-auto overflow-x-hidden overflow-y-scroll">
            <div class="relative text-slate-600 font-sans font-semibold">
                <div class="grid gap-2 py-1">
                    ...
                    <a href="{{ route('users') }}"
                        class="{{ Route::currentRouteName() == 'users' ? 'border-primary-500 bg-gray-100' : ' border-transparent' }} px-2 py-3 hover:bg-gray-100 hover:border-primary-500  flex cursor-pointer transition-colors flex-row items-center  border-r-2  ">
                        <div class="flex flex-row items-center text-sm font-medium">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                stroke-width="1.5" stroke="currentColor" aria-hidden="true"
                                class="h-5 w-5 pointer-events-none mx-3">
    ...
    <div id="content" class="relative p-4 flex-auto">
        {{ $slot }}
    </div>
</div>
