    ...
    <x-content>
        <div class="relative w-full overflow-x-hidden overflow-y-scroll">
            ...
            @foreach ($users as $user)
                <div
                    class=" md:flex-row flex-col relative flex items-center justify-between w-full border mb-3 border-slate-100 rounded-md">
                    <div
                    ...
                    <div
                        ...
                        <a href="" class="p-1 text-indigo-400 rounded-md mx-1 ">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                stroke-width="1.5" stroke="currentColor" class="w-4 h-4">
                                <path stroke-linecap="round" stroke-linejoin="round"
                    ...
                    <div class="relative ">
                        <span
                            class="{{ $user->email_verified_at != null ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800' }} md:truncate md:w-1/5 w-auto md:m-3 md:text-center
