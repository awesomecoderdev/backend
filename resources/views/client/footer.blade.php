<footer class="relative bg-white dark:bg-gray-900">
    <div class="relative px-6 py-8">
        <div class="relative max-w-7xl  mx-auto grid gap-8 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
            <div>
        ...
        <div class="relative max-w-7xl  mx-auto sm:flex sm:items-center sm:justify-between">
