<x-client-layout>
    ...
    <div class="bg-white dark:bg-gray-900">
        <x-container class=" px-6 py-8 mx-auto">
            <div class="flex justify-center items-center xl:-mx-8 xl:flex">
                <div class="flex flex-col items-center xl:items-center xl:mx-8">
            ...
            <div class="relative w-full overflow-x-hidden overflow-y-scroll py-14 ">
                            ...
                            <a href="{{ base(route('client.plans.show', $plan)) }}"
                                ...
                                <div class="relative">
                                    <div class="p-3">
                                        ...
                                        <h2
                                            class="mt-4 text-2xl font-medium text-gray-700 sm:text-4xl dark:text-gray-300">
                                        ...
                                        <div class="mt-8 space-y-4">
                                            @foreach ($plan->meta as $meta => $status)
                                                <div class="flex items-center">
                                                    ...
                                                    @else
                                                        <svg xmlns="http://www.w3.org/2000/svg"
                                                            class="w-5 h-5 text-red-400" viewBox="0 0 20 20"
                                                            fill="currentColor">
                                                            <path fill-rule="evenodd"
