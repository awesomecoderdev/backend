<x-client-layout>
    @section('head')
        <title>{{ __('Pricing') }} {{ config('settings.separator') }}
            {{ __(config('settings.title')) }}</title>
    @endsection
    <div class="bg-white dark:bg-gray-900">
        <x-container class=" px-6 py-8 mx-auto">
            <div class="xl:items-center xl:-mx-8 xl:flex">
                <div class="flex flex-col items-center xl:items-start xl:mx-8">
                    <h1 class="text-3xl font-medium text-gray-800 capitalize lg:text-4xl dark:text-white">Our Pricing
                        Plan</h1>
    ...
    <section class="bg-white dark:bg-gray-900">
        <x-container class=" px-6 py-16 mx-auto text-center">
