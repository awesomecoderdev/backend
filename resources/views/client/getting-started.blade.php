<x-client-layout>
    ...
    <section class="bg-white dark:bg-gray-900">
        <div class="sm:px-8 pt-6 sm:pt-12">
            <div class="mx-auto max-w-7xl lg:px-8">
                <div class="relative px-4 sm:px-8 lg:px-12">
                    <div class="mx-auto max-w-2xl lg:max-w-5xl">
                        <div class="grid grid-cols-1 gap-y-16 lg:grid-cols-2 lg:grid-rows-[auto_1fr] lg:gap-y-12">
                            <div class="lg:pl-20">
                                <div class="max-w-xs px-2.5 lg:max-w-none mx-auto"><img alt=""
                                        sizes="(min-width: 1024px) 32rem, 20rem"
                                        srcset="https://awesomecoderdev.github.io/img/profile.jpg?w=16&q=75 16w,
                                        https://awesomecoderdev.github.io/img/profile.jpg?w=32&q=75 32w,
                                        https://awesomecoderdev.github.io/img/profile.jpg?w=48&q=75 48w,
                                        https://awesomecoderdev.github.io/img/profile.jpg?w=64&q=75 64w,
                                        https://awesomecoderdev.github.io/img/profile.jpg?w=96&q=75 96w,
                                        https://awesomecoderdev.github.io/img/profile.jpg?w=128&q=75 128w,
                                        https://awesomecoderdev.github.io/img/profile.jpg?w=256&q=75 256w,
                                        https://awesomecoderdev.github.io/img/profile.jpg?w=384&q=75 384w,
                                        https://awesomecoderdev.github.io/img/profile.jpg?w=640&q=75 640w,
                                        https://awesomecoderdev.github.io/img/profile.jpg?w=750&q=75 750w,
                                        https://awesomecoderdev.github.io/img/profile.jpg?w=828&q=75 828w,
                                        https://awesomecoderdev.github.io/img/profile.jpg?w=1080&q=75 1080w,
                                        https://awesomecoderdev.github.io/img/profile.jpg?w=1200&q=75 1200w,
                                        https://awesomecoderdev.github.io/img/profile.jpg?w=1920&q=75 1920w,
                                        https://awesomecoderdev.github.io/img/profile.jpg?w=2048&q=75 2048w,
                                        https://awesomecoderdev.github.io/img/profile.jpg?w=3840&q=75 3840w"
                                        src="https://awesomecoderdev.github.io/img/profile.jpg?w=3840&q=75"
                                ...
                                <ul role="list">
                                    <li class="flex"><a
                                            ...
                                            href="#"><svg viewBox="0 0 24 24" aria-hidden="true"
                                                class="h-6 w-6 flex-none fill-zinc-500 transition group-hover:fill-primary-500">
                                                <path
                                    ...
                                    <li class="mt-8 border-t border-zinc-100 pt-8 dark:border-zinc-700/40 flex"><a
                                            class="group flex text-sm font-medium text-zinc-800 transition hover:text-primary-500 dark:text-zinc-200 dark:hover:text-primary-500"
                                            href="mailto:awesomecoder.dev@gmail.com"><svg viewBox="0 0 24 24"
                                                aria-hidden="true"
                                                class="h-6 w-6 flex-none fill-zinc-500 transition group-hover:fill-primary-500">
                                                <path fill-rule="evenodd"
                                                    d="M6 5a3 3 0 0 0-3 3v8a3 3 0 0 0 3 3h12a3 3 0 0 0 3-3V8a3 3 0 0 0-3-3H6Zm.245 2.187a.75.75 0 0 0-.99 1.126l6.25 5.5a.75.75 0 0 0 .99 0l6.25-5.5a.75.75 0 0 0-.99-1.126L12 12.251 6.245 7.187Z">
                                                </path>
                                            </svg><span class="ml-4">awesomecoder.dev@gmail.com</span></a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
