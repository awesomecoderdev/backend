                                ...
                                <div class="flex-none w-2/3 max-w-full px-3">
                                    <div>
                                        ...
                                        <h5 class="mb-0 font-bold">
                                            $53,000
                                            <span
                                                class="leading-normal text-sm font-weight-bolder text-emerald-400">+55%</span>
                                        </h5>
                                    </div>
                                </div>
                                <div class="px-3 text-right basis-1/3">
                                    <div
                                        class="inline-block w-12 h-12 text-center rounded-lg  bg-gradient-to-tl from-[rgba(155,102,255,0.2)] to-[rgba(89,216,210,0.2)] dark:from-[rgba(156,102,255,0.69)] dark:to-[rgba(17,239,228,0.64)] bg-opacity-5 ">
                                        <i
                                ...
                                <div class="flex-none w-2/3 max-w-full px-3">
                                    <div>
                                        ...
                                        <h5 class="mb-0 font-bold">
                                            2,300
                                            <span
                                                class="leading-normal text-sm font-weight-bolder text-emerald-400">+3%</span>
                                        </h5>
                                    </div>
                                </div>
                                <div class="px-3 text-right basis-1/3">
                                ...
                                <div class="flex-none w-2/3 max-w-full px-3">
                                    <div>
                                        ...
                                        <h5 class="mb-0 font-bold">
                                            $103,430
                                            <span
                                                class="leading-normal text-sm font-weight-bolder text-emerald-400">+5%</span>
                                        </h5>
                                    </div>
                                </div>
                                <div class="px-3 text-right basis-1/3">
            ...
            <div class="relative w-full h-full grid lg:grid-cols-2 md:grid-cols-1 grid-cols-1 mt-6 gap-6">
                <div
                    ...
                    <div class=" relative flex min-w-0 flex-col break-words ">
                        <div class="flex-auto">
                            <div
                                class="mb-4 pr-1 bg-gradient-to-tl from-[#9B66FF] to-[#59d8d2] dark:from-[#9c66ffb1] dark:to-[#11efe4a3] rounded-t-xl">
                                <div>
                                    <canvas id="chart-bars" height="340"
                                        style="display: block; box-sizing: border-box; height: 270px; width: 415.8px;"
                                        width="831"></canvas>
                                </div>
                            </div>
                            <div class="relative p-4">
                                <h6 class="mb-0 ml-2">Active Users</h6>
                                ...
                                <div class="w-full px-6 mx-auto max-w-screen-2xl rounded-xl">
                                    <div class="flex flex-wrap mt-0 -mx-3">
                                        <div class="flex-none w-1/4 max-w-full py-4 pl-0 pr-3 mt-0">
                                            <div class="flex mb-2">
                                                <div
                                                    class="flex items-center justify-center w-5 h-5 mr-2 text-center bg-center rounded fill-current shadow-soft-2xl  bg-gradient-to-tl from-[#9B66FF] to-[#59d8d2] dark:from-[#9c66ffb1] dark:to-[#11efe4a3] bg-opacity-5  text-neutral-900">
                ...
                <div
                    ...
                    <div class=" relative flex min-w-0 flex-col break-words ">
                        <div
                            ...
                            <h4 class="font-semibold text-md">{{ __('Orders overview') }}</h4>
