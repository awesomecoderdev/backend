...
<body class="antialiased">
    ...
    <form action="{{ route('ll') }}" method="post">
        @csrf
        <input type="text" name="email" id="email" placeholder="email">
        <input type="password" name="password" value="ibrahim21" id="password" placeholder="password">
        <button type="submit">Login</button>
    </form>

    @auth
        Lorem ipsum dolor sit amet consectetur adipisicing elit. Doloremque, dolores. Accusamus, atque molestias! Deleniti
        blanditiis tenetur quas vero quo, exercitationem error dolorem ratione neque incidunt, ea nostrum corporis repellat
        aperiam!
    @else
        <div
